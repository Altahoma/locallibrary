...
class AuthorCreateViewTest(TestCase):
    ...
    def test_logged_in_with_permission_create_book(self):
        login = self.client.login(username='testuser2', password='2HJ1vRV0Z&3iD')
        response = self.client.get(reverse('author-create'))
    ...
    def test_form_date_of_death_initially_has_current_day(self):
        login = self.client.login(username='testuser2', password='2HJ1vRV0Z&3iD')
        current_day = datetime.date.today()
        response = self.client.post(reverse('author-create'))
        self.assertEqual(response.status_code, 200)
        self.assertEqual(response.context['form'].initial['date_of_death'], current_day)
    ...
    def test_redirects_to_author_detail_on_success(self):
        ...
        response = self.client.post(reverse('author-create'), content)
        self.assertRedirects(response, reverse('author-detail', kwargs={'pk': Author.objects.get(id=1).pk}))
